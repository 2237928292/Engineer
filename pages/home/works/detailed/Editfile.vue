 ...
 安装、保养、维修任务未结束的，请选择否</text>
		...
		<view class="content">
			...
			<view v-for="(item,index) in content" :key="index" class="input">
				<image class="delete" @tap="deletecontent(index)" src="../../../../static/icon/icon/cancel.png" mode=""></image>
		...
		<view class="content">
			...
			<view v-for="(item,index) in text" :key="index" class="input">
				<image class="delete" @tap="deletetext(index)" src="../../../../static/icon/icon/cancel.png" mode=""></image>
				<input v-model="item.text" type="text" value="" class="zhi" />
			</view>
