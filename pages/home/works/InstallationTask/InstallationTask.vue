<template>
	<view class="box">
		...
		<view class="titles" v-if="Data.EnginnerDtos != undefined && Data.EnginnerDtos.length != 0">
			工程师
		</view>
		<!--  -->
		...
		<view v-if=" Data.Dto && Data.Dto.State == 7 && Data.Dto.TypeStr == '培训室拆装服务' "
		...
		<button class="lickgcs" v-if=" Data.Dto && Data.Dto.State == 7 && DataType == 2" @click="ClickOldPieces()"
			type="default" style="margin-bottom: 10px;">旧件寄回</button>
	...
	export default {
		data() {
			return {
				...
				fileList: [{
					url: 'https://pic2.zhimg.com/80/v2-e3ebfc7ba24b24fd88d21c193728c84d_1440w.jpg',
				}],
				OldPieces: false,
				SendBackData: [],
